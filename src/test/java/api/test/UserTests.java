...
public class UserTests {
	...
	public void testGetUserByName() {
		Response getUserResponse = UserEndPoints.getUser(this.userPayloads.getUsername());
	...
	public void testUpdateUserByName() {
		...
		Response updateUserResponse = UserEndPoints.updateUser(userPayloads.getUsername(), userPayloads);
	...
	public void testDeleteUserByName() {
		Response deleteUserResponse = UserEndPoints.deleteUser(this.userPayloads.getUsername());
